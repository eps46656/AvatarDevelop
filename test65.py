...
from . import (config, people_snapshot_utils, smplx_utils, tex_avatar_utils,
...
MODEL_DATA_PATH = config.DIR / \
    f"gom_avatar_{SUBJECT_SHORT_NAME}_2025_0624_1/model_data.pkl"

TEX_AVATAR_DIR = config.DIR / f"tex_avatar_{SUBJECT_SHORT_NAME}_2025_0624_1"
...
def main1():
    ...
    if False:
        ...
        init_tex = vision_utils.read_image(
            TEX_AVATAR_DIR / "tex_1750765250.png",
            "RGB"
    ...
    tex_avatar_trainer = training_utils.Trainer(
        ...
        tex_avatar_utils.TrainerCore(
            config=tex_avatar_utils.TrainerCoreConfig(
                ...
                lr=lambda epoch: 1e-1 * 0.95 ** epoch,
                betas=(0.5, 0.5),
            ),
